...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/kennethoyahebholo/forcythe.git
   ```
...
- **/src**: Contains all the source code for the application.
  - **/app**: Root.
  - **/screens**: React components used across the app represents screens/pages.
  - **/components**: React components used across the app.
  - **/utils**: Helper functions and utilities.
- **/public**: Contains static assets like images, svgs etc.
